...
//Teclas W,A,S,D controlam a câmera
//Tecla T trava a câmera
//Tecla shift aumenta a velocidade de movimento da câmera

var scene, camera, renderer, light, control, elements = new Array(), anchors = new Array(), lights = new Array()
...
var loadObject = function(typeLoader, link, texture_link, initial_position, initial_scale, initial_rotation,  name, normalMap_link = null, displacementMap_link = null, metalnessMap_link = null, roughnessMap_link = null, emissiveMap_link = null){
...
var animation = function (){
    ...
    if (controls){
		controls.update(relogio.getDelta());
        if(!keyPressed['shift']){
...
var init = function (){
    ...
    loadObject("fbx","assets/alligator/Alligator.fbx","assets/alligator/texture.png", positions[9], scales[9], rotations[9], "alligator");
    ...
    loadObject("fbx","assets/basketball%20player/Basketball%20Player.fbx","assets/basketball%20player/Basketball_player_texture.png", positions[11], scales[11], rotations[11], "basketball-player");
