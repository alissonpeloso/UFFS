...
happyExpList = Happy_Data_Array.listArray (0,32) ([3152,2,4096,50433,0,0,20501,35340,1,0,16581,5126,259,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","num","'+'","if","then","else","and","True","False","%eof"]
        bit_start = st * 13
        bit_end = (st + 1) * 13
